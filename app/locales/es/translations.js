  ...
  admin: {
    ...
    customForms: {
      ...
      labels: {
        ...
        checkbox: 'Checkbox',
        colSpan: 'Numero de Columnas a Span',
        columns: 'Columnas',
        customForm: 'Forma Personalizada',
        dischargeReportFormType: 'Reporte de Despidos',
        expenseTo: 'Gasto a',
        formName: 'Nombre de Forma',
        formType: 'Tipo de Forma',
        incidentFormType: 'Incidente',
        includeOtherOption: 'Incluir Otra Opcion',
        labFormType: 'Lab',
        label: 'Etiqueta',
        newForm: 'Forma Nueva',
        opdReportFormType: 'Reporte de Pacientes Externos',
        operativePlanFormType: 'Plan y Reporte Operativo',
        otherOptionLabel: 'Etiqueta de Otra Opcion',
      ...
      messages: { formSaved: 'La forma {{name}} ha sido guardada.' },
      titles: {
        checkboxValues: 'Valores de Checkbox',
        customForms: 'Formas Personalizadas',
        deleteForm: 'Eliminar Forma Personalizada',
        dropDownValues: 'Valores De Dropdown',
        editCustomForm: ' Editar Form Personalizada',
        fields: 'Campos',
        formSaved: 'Forma Grabada',
        newCustomForm: 'Forma Personalizada Nueva',
